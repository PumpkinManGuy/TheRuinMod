...
import theRuin.patches.relics.BottledPlaceholderField;
import theRuin.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theRuin.DefaultMod.makeRelicOutlinePath;
import static theRuin.DefaultMod.makeRelicPath;
