package theRuin.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import theRuin.cards.AbstractDefaultCard;

import static theRuin.DefaultMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "theRuin:" (or, your id) before the name.
    }
