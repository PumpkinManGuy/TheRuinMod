...
import theRuin.powers.CommonPower;

import static theRuin.DefaultMod.makeCardPath;
...
public class DefaultCommonPower extends AbstractDynamicCard {
    ...
    // Go check out DefaultAttackWithVariable and theRuin.variable.DefaultCustomVariable
